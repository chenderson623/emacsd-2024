...
;;;###autoload
(defun my-edit>move-to-char (arg char)
  (interactive (list (prefix-numeric-value current-prefix-arg)
                     (read-char "Move to char: " t)))
  (search-forward (char-to-string char) nil nil arg))

;;;###autoload
(defun my-edit>mark-to-char-exclusive (arg char)
  "Mark up to but not including ARGth occurrence of CHAR."
  (interactive (list (prefix-numeric-value current-prefix-arg)
                     (read-char "Mark to char: " t)))
  (set-mark
   (save-excursion
     (my-edit>move-to-char arg char)
     (backward-char)
     (point))))

;;;###autoload
(defun my-edit>mark-to-char-inclusive (arg char)
...
;;;###autoload
(defun my-edit>move-region-to-other-window (start end)
